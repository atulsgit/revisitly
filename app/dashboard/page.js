              ...
              <div style={s.formGrid}>
                ...
                <div style={s.field}>
                  ...
                  <input
                    ...
                    placeholder="e.g. Regular client, prefers morning appointments"
                  />
                </div>
              </div>
              <div style={s.formActions}>
                <button type="button" style={s.btnSecondary} onClick={() => setShowAddForm(false)}>
                  Cancel
                </button>
        ...
        <div style={s.tableCard}>
          ...
          {customers.length === 0 ? (
            <div style={s.emptyState}>
              ...
              <p style={s.emptyText}>Add your first customer to get started with automated follow-ups</p>
                    ...
                    <tr key={c.id} style={{ ...s.tr, ...(i % 2 === 0 ? s.trEven : {}) }}>
                      ...
                      <td style={s.td}>
                        <button
                          style={{
                            ...s.actionBtn,
                            ...(c.followup_sent ? s.actionBtnDone : {}),
                          }}
...
const s = {
  ...
  sidebarBottom: { borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 16 },
  bizInfo: { display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 },
  bizAvatar: {
    width: 36, height: 36,
  ...
  pageTitle: {
    ...
    color: '#f0f0f8', letterSpacing: '-0.5px',
  },
  ...
  th: {
    ...
    letterSpacing: '0.5px', padding: '12px 24px',
  ...
  tagSent: {
    ...
    border: '1px solid rgba(0,229,160,0.2)',
    color: '#00e5a0', padding: '3px 10px',
    borderRadius: 100, fontSize: '0.75rem', fontWeight: 600,
  },
  tagPending: {
    background: 'rgba(255,209,102,0.1)',
    border: '1px solid rgba(255,209,102,0.2)',
    color: '#ffd166', padding: '3px 10px',
    borderRadius: 100, fontSize: '0.75rem', fontWeight: 600,
  },
  actionBtn: {
    background: 'rgba(0,229,160,0.08)',
    border: '1px solid rgba(0,229,160,0.2)',
    color: '#00e5a0', padding: '7px 14px',
